...
const createOraculistasStore = () =>
  createStore<OraculistasStore>()((set) => ({
    ...initialState,
...
let store: ReturnType<typeof createOraculistasStore>

const initializeStore = (preloadedState: Partial<OraculistasStore> = {}) => {
  const _store = store ?? createOraculistasStore()
...
export const useOraculistasStore = create<OraculistasStore>(initializeStore)
